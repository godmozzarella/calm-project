...
Сценарии использования — *в разработке (Приложение 2).*
...
Техническое задание — *в разработке (Приложение 3).*
...
Раскадровка интерфейса — *в разработке (Приложение 4).*
...
Unit-тесты — *в разработке (Приложение 6).*
...
#### Приложение 7. Используемые внешние API
